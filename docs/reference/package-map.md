...
| `internal/memory` | `feature` | Optional Hindsight long-term memory backend: lazy client (retain/recall/reflect), project-scoped bank derivation, formatting. No-op when `memory.backend` is off. |
